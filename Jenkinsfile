    ...
    stages {
        ...
        stage('Push SolarBase Docker Image to ECR') {
            steps {
                ...
                sh "aws ecr get-login-password --region ${AWS_DEFAULT_REGION} --debug| sudo docker login --username AWS --password-stdin 319670758662.dkr.ecr.ca-central-1.amazonaws.com/solarbase-backend --debug"
